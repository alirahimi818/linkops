...
export function IconWhatsApp({ className, title }: IconProps) {
  return (
    ...
    >
      {title ? <title>{title}</title> : null}
      <path
        d="M12 21a9 9 0 10-7.9-4.6L3 21l4.7-1.1A9 9 0 0012 21z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M9.2 8.8c.2-.5.6-.7 1.1-.7h.4c.3 0 .6.2.7.5l.8 2.1c.1.3 0 .6-.2.8l-.6.6c-.2.2-.2.4-.1.6.5 1 1.6 2.1 2.6 2.6.2.1.4.1.6-.1l.6-.6c.2-.2.5-.3.8-.2l2.1.8c.3.1.5.4.5.7v.4c0 .5-.2.9-.7 1.1-.7.3-2 .5-3.7-.2-2-.9-4.3-3.1-5.1-5.1-.7-1.7-.5-3-.2-3.7z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
