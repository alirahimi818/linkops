  ...
  return [
    {
      ...
      content: [
        ...
        "- Length: strictly 180–280 characters (count spaces too). DO NOT write the character count or any note like '(214 chars)' in the output.",
        "- Output each reply as clean plain text — no length notes, no parentheses with char count, nothing extra.",
